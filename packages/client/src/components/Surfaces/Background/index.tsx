...
export default function Background({ variant = 'default' }: BackgroundProps) {
  ...
  if (variant === 'top')
    return (
      <div className="background bg-iphone-top bg-contain bg-no-repeat bg-center absolute sm:w-[430px] sm:h-[32px] z-20 transform translate-x-[-28px] translate-y-[-1px] invisible sm:visible"></div>
    );
  return (
